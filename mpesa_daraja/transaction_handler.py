from KRWAPIendpoint.settings import Consumer_Key, Consumer_Secret, BusinessShortCode, Passkey, TransactionType, PartyB, AccountReference, TIME_ZONE
...
class Transaction:
    ...
    def stk_push(self, phone: str, amount: int, accountReference: str, transactionDesc: str):
        headers = {
